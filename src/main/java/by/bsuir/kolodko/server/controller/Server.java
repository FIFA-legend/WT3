package by.bsuir.kolodko.server.controller;

import by.bsuir.kolodko.connection.Message;
import by.bsuir.kolodko.scanner.ScanTool;
import by.bsuir.kolodko.server.entity.Role;
import by.bsuir.kolodko.server.entity.Student;
import by.bsuir.kolodko.server.entity.User;
import by.bsuir.kolodko.server.service.ServiceFactory;
import by.bsuir.kolodko.server.service.StudentService;
import by.bsuir.kolodko.server.service.UserService;
import by.bsuir.kolodko.server.service.validator.Validator;
import by.bsuir.kolodko.server.service.validator.ValidatorFactory;
import by.bsuir.kolodko.connection.MessageType;
import by.bsuir.kolodko.connection.Connection;
